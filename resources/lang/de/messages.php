...
return [
    ...
    */
    ...
    'Write access.description.1-3' => 'Hier können Sie ganz einfach überprüfen, ob in wichtige Systemdateien geschrieben werden kann. Dies ist wichtig, damit jede Funktion ordnungsgemäß funktioniert. Mit einem gekennzeichnete Einträge',
    'Write access.description.2-3' => 'Funktioniert wie erwartet, mit a markierte Einträge',
    'Write access.description.3-3' => 'unterlassen Sie.',
    'File' => 'Datei',
    'Dependencies' => NULL,
    ...
    'DISPLAY_FOOTER_HOME.title' => 'Link zur Fußzeile der Startseite',
    ...
    'ALLOW_REGISTRATION.description' => 'Legt fest, ob sich Benutzer für Ihre Anwendung registrieren können.',
    'NOTIFY_EVENTS.title' => 'Benachrichtigen Sie über Ereignisse',
    ...
    'DISPLAY_CREDIT.title' => 'Guthaben auf Benutzerseiten anzeigen',
    'DISPLAY_CREDIT.description' => 'Legt fest, ob die Gutschriftsbenachrichtigung auf den Benutzerseiten angezeigt werden soll.',
    'DISPLAY_CREDIT_FOOTER.title' => 'Credits in der Fußzeile anzeigen',
    'DISPLAY_CREDIT_FOOTER.description' => 'Legt fest, ob die Gutschriftsanzeige in der Fußzeile angezeigt werden soll.',
    'HOME_URL.title' => 'Legen Sie die Benutzerseite als Startseite fest',
    ...
    'ALLOW_USER_HTML.description' => 'Dadurch können Benutzer spezielle Formatierungen wie Überschriften und Links in ihrer Seitenbeschreibung verwenden.<br>Dies gilt allgemein als sicher.',
    ...
    'ENABLE_BUTTON_EDITOR.title' => 'Aktivieren Sie den Schaltflächeneditor',
    'ENABLE_BUTTON_EDITOR.description' => 'Legt fest, ob Benutzer ihre eigenen Schaltflächen mit CSS anpassen dürfen.',
    ...
    'MAINTENANCE_MODE.description' => 'Zeigt auf allen öffentlichen Seiten eine Wartungsmeldung an. Dadurch werden die Anmeldeseiten deaktiviert.',
    ...
    'SKIP_UPDATE_BACKUP.description' => 'Überspringt Backups beim Aktualisieren. Es wird empfohlen, diese Option immer zu deaktivieren. <br>Sie kann jedoch bei einigen Konfigurationen zu Fehlern führen.',
    ...
    'ENABLE_SOCIAL_LOGIN.description' => 'Aktiviert die soziale Anmeldung. Diese Option erfordert eine weitere Einrichtung. Lesen Sie mehr darüber <a target=\'_blank\' href=\'https://linkstack.org/social-login\'>hier</a>.',
    'USE_THEME_PREVIEW_IFRAME.title' => 'Verwenden Sie iframe als Theme-Vorschau',
    ...
    'FORCE_ROUTE_HTTPS.description' => 'Diese Option NICHT mit einen Reverse-Proxy verwenden!',
    ...
    'TITLE_FOOTER_TERMS.description' => 'Titel der Begriffe, Fußzeilenlink.',
    ...
    'MANUAL_USER_VERIFICATION.title' => 'Überprüfen Sie Benutzer manuell',
    ...
    */
    ...
    'Backup' => 'Backup',
    'You can back up your entire instance:' => 'Sie können Ihre gesamte Instanz sichern:',
    'The backup system won’t save more than two backups at a time' => 'Das Sicherungssystem speichert gleichzeitig nicht mehr als zwei Backups.',
