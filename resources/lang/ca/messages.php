<?php
    ...
    /*
    |--------------------------------------------------------------------------
    | Traducció realitzada per Francesc Roy
    |--------------------------------------------------------------------------
    */
    ...
    */
    ...
    'HOME.MESSAGE' => '
    <p>Controleu la vostre presència en línea amb&nbsp;<a href="https://linkstack.org/"><strong>LinkStack</strong></a>,
    la plataforma de gestió d\'enllaços <strong>open-source</strong> centrada en la privacitat. Creeu una pàgina de perfil personalitzable per gestionar <strong>
    tots els vostres enllaços importants en un sol lloc</strong> i oferiu al vostre públic una experiència de navegació transparent.</p>
    ',

    /*
    |--------------------------------------------------------------------------
    | Pàgina de demostració / Pàgina d'exemple de la pàgina d'inici
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    'Example page' => 'Pàgina d\'exemple',

    /*
    |--------------------------------------------------------------------------
    | Pàginess d'autenticació
    |--------------------------------------------------------------------------
    |
    | Inici de sessió, registre, restablir la contrasenya, etc.
    | Això inclou correus electrònics d'autenticació com restabliment de contrasenya y verificació de correu electrònic.
    ...
    */
    ...
    'Login to stay connected' => 'Inicia sessió per mantenir-te connectat',
    'Email' => 'Correu electrònic',
    'Password' => 'Contrasenya',
    'Remember Me' => 'Recorda\'m',
    'Forgot Password?' => 'Heu oblidat la vostre contrasenya?',
    'or sign in with other accounts?' => 'o inicieu sessió amb altres comptes?',
    'Don’t have an account?' => 'No teniu cap compte?',
    'Click here to sign up' => 'Feu clic aquí per registrar-vos',
    ...
    */
    ...
    # Title Tag
    'LinkStack setup' => 'Configuració del LinkStack',

    'Setup LinkStack' => 'Instal·lació del LinkStack',
    'Welcome to the setup for LinkStack!' => 'Benvingut a la configuració del LinkStack!',
    'This setup will:' => 'Aquesta instal·lació s\'ocuparà de:',
    'Check the server dependencies' => '1. Verificació de les dependències del servidor',
    'Setup the database' => '2. Configuració de la base de dades',
    'Create the admin user' => '3. Creació de l\'usuari administrador',
    'Configure the app' => '4. Configuració de l\'aplicació',
    'Choose a language' => 'Esculliu un idioma',
    'setup.disclaimer' => 'Si continueu, estareu acceptant els nostres',
    'Terms and Conditions' => 'termes i condicions',
        
    'Next' => 'Següent',
    'Yes' => 'Sí',
    'No' => 'No',
    'Finish setup' => 'Finaliza la configuració',
        
    'Setup failed' => 'La configuració ha fallat',
    'An error has occured. Please try again' => 'Hi ha hagut un error. Intenteu-ho de nou.',
    'Depending on your database type:' => 'En funció del tipus de base de dades:',
    'Try again' => 'Prova de nou',
        
    'Dependency check' => 'Verificació de dependències',
    'Required PHP modules:' => 'Mòduls PHP requerits:',
        
    'Select a database type' => 'Seleccioneu un tipus de base de dades',
    'Under most circumstances, we recommend using SQLite' => 'En la majoria dels casos, recomanem l\'ús d\'SQLite.',
    'MySQL requires a separate, empty MySQL database' => 'El MySQL requereix una base de dades MySQL separada i buida.',
    ...
    'Configure your page' => 'Configureu la vostra pàgina',
    'Enable registration:' => 'Habilita el registre:',
    'Enable email verification:' => 'Habilita la verificació del correu electrònic:',
    'Set your page as Home Page' => 'Estableix la meva pàgina com a Pàgina d\'inici',
    'This will move the Home Page to /home' => 'Això mourà la Pàgina d\'inici a /home',
