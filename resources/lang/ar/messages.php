...
return [
    ...
    */
    ...
    'HOME.MESSAGE' => '<p>خذ السيطرة على وجودك عبر الإنترنت مع <a href="https://linkstack.org/"><strong>LinkStack</strong></a>، منصة إدارة الروابط ذات المصدر المفتوح والموجهة نحو الخصوصية. قم بإنشاء صفحة ملف تعريف قابلة للتخصيص لإدارة <strong>جميع روابطك الهامة في مكان واحد مريح</strong> وتمنح جمهورك تجربة تصفح سلسة.</p>',
    ...
    */
    ...
    'A new user has registered on' => 'تم تسجيل مستخدم جديد علي',
    'and is awaiting verification' => 'وينتظر تفعيل حسابه',
    'The user' => 'المستخدم',
    'with the email' => 'عن طريق بريد الكتروني',
    'has registered a new account on' => 'سجل حساب جديد علي',
    ...
    */
    ...
    'Custom Alert' => 'لا يحتوي رمز الأيقونة المخصصة الخاص بك على سلسلة "fa-"، يرجى استخدام الأيقونات بتنسيق fa-ghost على سبيل المثال.',
