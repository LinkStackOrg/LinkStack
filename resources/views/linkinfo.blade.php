          ...
          <div class="container mt-4">
            <div style="height: 89vh;" class="row align-items-center justify-content-center">
                ...
                <div class="d-flex flex-column flex-md-row align-items-md-center">
                    ...
                    <button class="btn btn-danger me-md-3 mb-3 mb-md-0"><a href="{{ route('deleteUserAdmin', ['id' => $id]) }}" target="_blank" class="text-white confirmation">{{__('messages.Delete')}} {{strtolower(__('messages.User'))}}</a></button>
                  </div>
