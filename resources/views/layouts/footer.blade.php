...
@if(env('DISPLAY_FOOTER') === true)
    @if(config('meta.display_link_home') != 'false')<a class="footer-hover spacing" @if(config('meta.custom_link_home') != '')href="{{ config('meta.custom_link_home') }}"@else href="{{ url('') }}/"@endif> @if(config('meta.custom_text_home') != ''){{config('meta.custom_text_home')}}@else Home @endif</a>@endif
    @if(config('meta.display_link_terms') != 'false')<a class="footer-hover spacing" href="{{ url('') }}/pages/terms">Terms</a>@endif
    @if(config('meta.display_link_privacy') != 'false')<a class="footer-hover spacing" href="{{ url('') }}/pages/privacy">Privacy</a>@endif
