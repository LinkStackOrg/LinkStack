                                            ...
                                            <div class='col h-100'>
                                                ...
                                                <div class='row h-100'>
                                                    ...
                                                    <div class='col-12 py-1 px-3 m-0 mt-2'>
                                                        ...
                                                        <a style="float: right;" href="{{ route('deleteLink', $link->id ) }}" onclick="return confirm('Are you sure you want to delete `{{$link->title}}` ?')" class="btn btn-sm me-1 btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Delete" data-bs-placement="top" data-original-title="{{__('messages.Delete')}}">
