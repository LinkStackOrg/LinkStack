  ...
  <div class="container">
    <div class="row">
      <div class="column" style="margin-top: 5%">
        ...
        <!-- Your Name -->
        <h1 class="fadein">{{ $info->name }}@if($userinfo->role == 'vip' or $userinfo->role == 'admin') <img alt="verified" class="fadein" style="width: 25px; margin: -4px;" src="{{ asset('littlelink/images/verify.png') }}"> @endif</h1>
