...
<div class="containerr" style="">
      <div class="column">
        <!-- Your Image Here -->
        @if(file_exists(base_path("arcanelink/images/avatar.png" )))
        <img alt="avatar" src="{{ asset('content/images/avatar.png') }}" srcset="{{ asset('content/images/avatar@2x.png 2x') }}" width="200px" height="200px">
        @else
        <div class="logo-container">
           <img src="{{ asset('content/images/arcanelink-logo.png') }}" alt="Logo" style="width:200px; height:200px;">
        </div>
        @endif
